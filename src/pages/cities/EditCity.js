...
import { fetchCityById, updateCity } from '../../data/requests/cities';
...
export const EditCity = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await updateCity(region, params.id, data);
